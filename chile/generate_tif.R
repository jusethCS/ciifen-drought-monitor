...
x.range <- as.numeric(c(-78.00, -65.25))   # Longitude range
y.range <- as.numeric(c(-57.00, -16.50))      # Latitude range
...
est_contour <- rgdal::readOGR("assets", "chile")
...
est_contour_k <- rgdal::readOGR("assets", "chile")
