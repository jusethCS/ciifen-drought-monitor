...
x.range <- as.numeric(c(-83.00, -66.50))   # Longitude range
y.range <- as.numeric(c(-19.00, 0.50))      # Latitude range
...
est_contour <- rgdal::readOGR("assets", "peru")
...
est_contour_k <- rgdal::readOGR("assets", "peru")
